...
contract CounterHookTest is Test {
    ...
    function testBeforeSwapIncrementsCount() public {
        ...
        counter.beforeSwap(address(this), poolKey, IPoolManager.IPoolManager.SwapParams({amountSpecified: 0, sqrtPriceLimitX96: 0, zeroForOne: false}), "");
    ...
    function testAfterSwapIncrementsCount() public {
        ...
        counter.afterSwap(address(this), poolKey, IPoolManager.IPoolManager.SwapParams({amountSpecified: 0, sqrtPriceLimitX96: 0, zeroForOne: false}), BalanceDelta memory({amount0: 0, amount1: 0}), "");
    ...
    function testBeforeAddLiquidityIncrementsCount() public {
        ...
        counter.beforeAddLiquidity(address(this), poolKey, IPoolManager.IPoolManager.ModifyLiquidityParams({tickLower: 0, tickUpper: 0, liquidityDelta: 0, salt: 0}), "");
    ...
    function testBeforeRemoveLiquidityIncrementsCount() public {
        ...
        counter.beforeRemoveLiquidity(address(this), poolKey, IPoolManager.IPoolManager.ModifyLiquidityParams({tickLower: 0, tickUpper: 0, liquidityDelta: 0, salt: 0}), "");
...
contract ConcreteMockPoolManager is MockPoolManager {
  ...
  function donate(PoolKey memory, uint256, uint256, bytes calldata) external override returns (BalanceDelta) { return BalanceDelta({amount0: {amount0: 0, amount1: amount1: 0}}); }
  ...
  function modifyLiquidity(PoolKey memory, IPoolManager.ModifyLiquidityParams memory, bytes calldata) external override returns (BalanceDelta memory, bytes memory) { return (BalanceDelta({amount0: {amount0: 0, amount1: amount1: 0}}), bytes("")); }
  ...
  function swap(PoolKey memory, IPoolManager.SwapParams memory, bytes calldata) external override returns (BalanceDelta memory, bytes memory) { return (BalanceDelta({amount0: {amount0: 0, amount1: amount1: 0}}), bytes("")); }
