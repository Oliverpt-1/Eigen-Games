...
const {AuditDatabaseUtils } = require('./audit-database');
 ...
 */
async function securityCheck(solidityCode, model = QWEN_CODER_MODEL) {
...
function parseAnalysisResponse(responseText, originalCode, maliciousCodeCheck) {
  try {
    ...
    if (jsonMatch && jsonMatch[1]) {
      ...
      // If no JSON code block markers, try to find JSON object directly
